...
class NativeLibrary {
  ...
  late final _ParseDataPtr = _lookup<
      ffi.NativeFunction<
          ParseResult Function(ffi.Pointer<ffi.Int8>, ffi.Int32)>>('ParseData');
  late final _ParseData = _ParseDataPtr.asFunction<
      ParseResult Function(ffi.Pointer<ffi.Int8>, int)>();
  ...
  late final _FakeCallPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('FakeCall');
  late final _FakeCall = _FakeCallPtr.asFunction<void Function()>();
}
...
class ParseResult extends ffi.Struct {
